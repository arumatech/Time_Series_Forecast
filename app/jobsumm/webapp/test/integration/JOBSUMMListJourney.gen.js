...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("JOBSUMMListListReport journey");
        ...
        opaTest("Start application", function (Given, When, Then) {
            ...
            Then.onTheJOBSUMMListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheJOBSUMMListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheJOBSUMMListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheJOBSUMMListGenerated.onTable(defaultTableId).iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheJOBSUMMListGenerated.onFilterBar().iExecuteSearch();
            Then.onTheJOBSUMMListGenerated.onTable(defaultTableId).iCheckRows();
            When.onTheJOBSUMMListGenerated.onTable(defaultTableId).iPressRow(0);
            Then.onTheJOBSUMMObjectPageGenerated.iSeeThisPage();
        });
