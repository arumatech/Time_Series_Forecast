...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("FLATFILEListListReport journey");
        ...
        opaTest("Start application", function (Given, When, Then) {
            ...
            Then.onTheFLATFILEListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheFLATFILEListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheFLATFILEListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheFLATFILEListGenerated.onTable(defaultTableId).iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheFLATFILEListGenerated.onFilterBar().iExecuteSearch();
            Then.onTheFLATFILEListGenerated.onTable(defaultTableId).iCheckRows();
            When.onTheFLATFILEListGenerated.onTable(defaultTableId).iPressRow(0);
            Then.onTheFLATFILEObjectPageGenerated.iSeeThisPage();
        });
